...
| File | Load it when |
| --- | --- |
| `references/diagram-system.md` | You need the component names, the file key, the page list, and the variant props and modes for the system. The source of truth for what exists in the file (verified against the live file on 2026-06-01). |
